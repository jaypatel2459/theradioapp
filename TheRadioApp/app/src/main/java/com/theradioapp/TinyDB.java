...
public class TinyDB {
    ...
    public TinyDB(Context appContext) {
        preferences = appContext.getSharedPreferences("radio_app", Context.MODE_PRIVATE);
    }
    ...
    public static void updateListeningTime(long diff, TinyDB tinyDB) {
        ...
        int a = (int) diffSeconds + tinyDB.getInt(AppConstatnts.TOTAL_LISTENING_SEC);
        if (a > 59) {
            a = a - 60;
            tinyDB.putInt(AppConstatnts.TOTAL_LISTENING_MIN,(tinyDB.getInt(AppConstatnts.TOTAL_LISTENING_MIN)+1));
        }
        tinyDB.putInt(AppConstatnts.TOTAL_LISTENING_SEC, a);
//        Log.e(TAG, "updateListeningTime: SEC::::" + String.valueOf(a));

        a = (int) diffMinutes + tinyDB.getInt(AppConstatnts.TOTAL_LISTENING_MIN);
        if (a > 59) {
            a = a - 60;
            tinyDB.putInt(AppConstatnts.TOTAL_LISTENING_HOUR,(tinyDB.getInt(AppConstatnts.TOTAL_LISTENING_HOUR)+1));
        }
        tinyDB.putInt(AppConstatnts.TOTAL_LISTENING_MIN, a);
//        Log.e(TAG, "updateListeningTime: MIN::::" + String.valueOf(a));


        a = (int) diffHours + tinyDB.getInt(AppConstatnts.TOTAL_LISTENING_HOUR);
        if (a > 23) {
            a = a - 24;
            tinyDB.putInt(AppConstatnts.TOTAL_LISTENING_DAYS,(tinyDB.getInt(AppConstatnts.TOTAL_LISTENING_DAYS)+1));
        }
        tinyDB.putInt(AppConstatnts.TOTAL_LISTENING_HOUR, a);
//        Log.e(TAG, "updateListeningTime: HOUR::::" + String.valueOf(a));


        a = (int) diffDays + tinyDB.getInt(AppConstatnts.TOTAL_LISTENING_DAYS);
        if (a > 364) {
            a = a - 365;
        }
        tinyDB.putInt(AppConstatnts.TOTAL_LISTENING_DAYS, a);
//        Log.e(TAG, "updateListeningTime: DAYS::::" + String.valueOf(a));

        tinyDB.putString(AppConstatnts.TOTAL_FINAL_LISTENING_TIME,
                String.valueOf(tinyDB.getInt(AppConstatnts.TOTAL_LISTENING_DAYS)) + "D " +
                        String.valueOf(tinyDB.getInt(AppConstatnts.TOTAL_LISTENING_HOUR)) + "H " +
                        String.valueOf(tinyDB.getInt(AppConstatnts.TOTAL_LISTENING_MIN)) + "M " +
                        String.valueOf(tinyDB.getInt(AppConstatnts.TOTAL_LISTENING_SEC)) + "S");

//        Log.e(TAG, "updateListeningTime: FINAL_TIME::::" + tinyDB.getString(AppConstatnts.TOTAL_FINAL_LISTENING_TIME));
